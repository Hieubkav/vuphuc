...
@section('content')
    <!-- Hero Banner -->
    @include('components.tutorial.hero-banner')
    
    <!-- Khóa Học Làm Bánh -->
    <section id="all-courses" class="animate-on-scroll py-16 md:py-24 bg-white">
        @include('components.storefront.baking-courses')
    </section>
    
    <!-- Cột Mốc Khóa Học -->
    <section class="animate-on-scroll py-16 md:py-24 bg-gray-50">
        @include('components.storefront.course-timeline')
    </section>
    
    <!-- Đánh giá của học viên -->
    <section class="animate-on-scroll py-16 md:py-24 bg-white">
        @include('components.tutorial.student-testimonials')
    </section>
    
    <!-- Đăng Ký Khóa Học -->
    <section id="course-registration" class="animate-on-scroll py-16 md:py-24 bg-gray-50">
        @include('components.storefront.course-registration')
    </section>
    
    <!-- FAQ - Câu hỏi thường gặp về khóa học -->
    <section class="animate-on-scroll py-16 md:py-24 bg-white">
        @include('components.tutorial.course-faq')
    </section>
    
    <!-- Call To Action -->
    <section class="py-14 md:py-20 bg-gradient-to-r from-red-800 via-red-700 to-red-600 text-white relative overflow-hidden">
        @include('components.tutorial.course-cta')
    </section>
@endsection
