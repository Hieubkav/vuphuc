...
<div class="container mx-auto px-4">
    <div class="flex flex-col lg:flex-row gap-10 items-center">
        ...
        <div class="lg:w-1/2 space-y-5">
            <div>
                <span class="inline-block py-1 px-3 text-xs font-semibold bg-red-100 text-red-800 rounded-full tracking-wider">{{ $aboutData->subtitle ?? 'VỀ CHÚNG TÔI' }}</span>
            ...
            <div class="prose prose-lg max-w-none text-gray-600">
                ...
                <div class="mt-6 border-l-4 border-red-600 pl-6 italic">
                    <p class="text-xl font-medium text-gray-800">"{{ webDesignContent('about-us', 'quote') }}", do vậy chúng tôi không ngừng nỗ lực tìm kiếm những giải pháp về kỹ thuật, công nghệ và phương thức bán hàng để có thể hỗ trợ công việc kinh doanh của khách hàng một cách tốt nhất."</p>
                </div>
                @endif
            </div>

            @if($aboutData->button_text && $aboutData->button_url)
            <div class="pt-4">
