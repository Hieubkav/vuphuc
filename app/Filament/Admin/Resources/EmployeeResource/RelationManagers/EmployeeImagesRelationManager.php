...
class EmployeeImagesRelationManager extends RelationManager
{
    protected static string $relationship = 'images';

    protected static ?string $title = 'Hình ảnh nhân viên';
            ...
            ->schema([
                FileUpload::make('image_link')
                    ...
                    ->saveUploadedFileUsing(function ($file, $get, $livewire) {
                        ...
                        $employeeName = $livewire->ownerRecord->name ?? 'nhan-vien';
                        return $imageService->saveImage(
                            ...
                            600,   // height
                            90,    // quality
                            "gallery-{$employeeName}" // SEO-friendly name
                        );
                    })
                    ->columnSpanFull(),
